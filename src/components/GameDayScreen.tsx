        ...
        >
          ...
          <div className="flex items-center gap-2">
            <button
              onClick={(e) => {
                e.stopPropagation();
                onNavigate('rotations');
              }}
              className="px-2.5 py-1 text-xs font-black bg-amber-500 hover:bg-amber-400 text-slate-950 rounded-lg transition shadow-xs flex items-center gap-1.5 cursor-pointer"
              title="Open Rotations Plan Page"
            >
              <RefreshCw className="w-3.5 h-3.5" />
              <span>Rotations Page</span>
            </button>
            <span className="text-[10px] font-black text-blue-100 bg-white/10 px-2.5 py-1 rounded-lg uppercase tracking-wider hidden sm:inline">
              {scoreboardCollapsed ? 'Expand' : 'Collapse'}
            </span>
            {scoreboardCollapsed ? (
        ...
        >
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="px-2.5 py-1 text-[11px] font-extrabold bg-indigo-50 hover:bg-indigo-100 text-indigo-700 border border-indigo-200 rounded-lg transition flex items-center gap-1 cursor-pointer"
            >
        ...
        <div className="xl:col-span-2 space-y-3">
          ...
          {fieldViewMode === 'list' ? (
            ...
            <div className="overflow-x-auto pb-4 flex justify-center">
              <div className="field relative select-none w-full max-w-[600px]">
