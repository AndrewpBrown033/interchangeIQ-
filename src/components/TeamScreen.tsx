...
import { Player, LineupTemplate, GameHistory, SkillAssessment, TeamProfile } from '../types';
import TeamEditModal from './TeamEditModal';
import { POSITION_GROUPS, POSITIONS, DEFAULT_PLAYERS, normalizePosition, getZoneForPosition, POSITION_FULL_NAMES, POSITION_HEIGHT_FACTOR } from '../constants';
...
export default function TeamScreen({
  ...
  const formHeightResult = formHeightCmNum > 0 ? classifyHeight(formHeightCmNum, formGender, formAgeGroup) : null;
  ...
  const handleOpenEditPlayer = (p: Player) => {
    ...
    setFormHeightGroupOverride(p.heightGroupOverride || '');
    setFormError('');
    setShowAddEditModal(true);
  };
  ...
  const handleSavePlayer = () => {
    ...
    const data: Partial<Player> = {
      ...
      status: formStatus,
      note: formNote.trim(),
      // 0 = genuinely unrecorded — never silently coerced to a fake default,
    ...
    <div className="space-y-6">
      ...
      {activePlayer ? (
        <div className="space-y-6 animate-fadeIn">
          ...
          <div className="bg-gradient-to-r from-[var(--navy)] via-[#102A43] to-indigo-900 p-4 rounded-2xl border border-indigo-800 shadow-md space-y-3">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-white/10 pb-3">
              <div className="flex items-center gap-3">
                ...
                >
                  <ArrowLeft className="w-4 h-4 text-[var(--green)]" />
                ...
                <div className="flex items-center gap-2.5">
                  ...
                  <div>
                    <h2 className="text-lg font-black text-white leading-tight">
                      {activePlayer.name} {activePlayer.nick && <span className="text-[var(--amber)] text-xs font-bold">({activePlayer.nick})</span>}
                    </h2>
                    <div className="flex items-center gap-2 mt-0.5">
                      ...
                      <span className={`px-2 py-0.5 text-[9px] font-black rounded-md uppercase border ${
                        ...
                        activePlayer.status === 'other_team' ? 'bg-purple-500/20 text-purple-200 border-purple-400/30' : 'bg-amber-500/20 text-[var(--amber)] border-[var(--amber)]/30'
                      }`}>
              ...
              <div className="flex items-center gap-2 flex-wrap">
                ...
                <button
                  ...
                  className="px-3 py-2 bg-[var(--amber)] hover:opacity-90 border border-[var(--amber)] text-slate-950 font-extrabold text-xs rounded-xl transition flex items-center gap-1.5 cursor-pointer"
                >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            <div className="lg:col-span-7 space-y-6">
              ...
              <div className="bg-white rounded-2xl border border-[var(--line)] shadow-xs overflow-hidden">
                <div className="flex items-center justify-between px-5 py-3.5 bg-gradient-to-r from-[var(--navy)] via-[#102A43] to-indigo-900">
                  <div className="flex items-center gap-2">
                    <User className="w-4.5 h-4.5 text-[var(--amber)]" />
                  ...
                  <button
                    onClick={() => handleOpenEditPlayer(activePlayer)}
                    className="text-xs font-extrabold text-[var(--amber)] hover:text-[var(--amber)] bg-white/10 hover:bg-white/15 px-2.5 py-1 rounded-lg border border-white/15 cursor-pointer"
                  >
                    Edit Physicals
                  </button>
                </div>
              ...
              {topChoice && (
                <div className="bg-gradient-to-br from-[var(--navy)] via-[#102A43] to-indigo-900 text-white p-5 rounded-2xl border border-indigo-800 shadow-md space-y-4">
                  <div className="flex items-center justify-between border-b border-indigo-800/80 pb-3">
                    <div className="flex items-center gap-2">
                      <Sparkles className="w-5 h-5 text-[var(--amber)] animate-pulse" />
                      <h3 className="text-sm font-black text-[var(--amber)] uppercase tracking-wider">
                    ...
                    {onNavigateTab && (
                      <button
                        ...
                        className="text-xs font-extrabold text-[var(--amber)] hover:underline cursor-pointer"
                      >
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 bg-white/5 p-3.5 rounded-xl border border-white/10">
                    ...
                    <div className="text-right">
                      <span className={`px-2.5 py-1 rounded-full text-xs font-black uppercase border ${
                        ...
                        'bg-amber-500/20 text-[var(--amber)] border-[var(--amber)]/30'
                      }`}>
                  ...
                  <div className="text-[11px] text-indigo-200 flex items-center justify-between flex-wrap gap-2 pt-1 border-t border-indigo-800/50">
                    ...
                    <span className="text-[10px] bg-[var(--amber)]/20 text-[var(--amber)] font-bold px-2 py-0.5 rounded border border-amber-300/30">
            ...
            <div className="lg:col-span-5 space-y-6">
              ...
              <div className="bg-white rounded-2xl border border-[var(--line)] shadow-xs overflow-hidden">
                <div className="flex items-center justify-between px-5 py-3.5 bg-gradient-to-r from-[var(--navy)] via-[#102A43] to-indigo-900">
                  <div className="flex items-center gap-2">
                    <Award className="w-4.5 h-4.5 text-[var(--amber)]" />
                    <h3 className="text-sm font-black text-white uppercase tracking-wider">
              ...
              <div className="bg-white rounded-2xl border border-[var(--line)] shadow-xs overflow-hidden">
                <div className="flex items-center justify-between px-5 py-3.5 bg-gradient-to-r from-[var(--navy)] via-[#102A43] to-indigo-900">
                  <div className="flex items-center gap-2">
                    <Target className="w-4.5 h-4.5 text-[var(--amber)]" />
                    <h3 className="text-sm font-black text-white uppercase tracking-wider">
              ...
              <div className="bg-white rounded-2xl border border-[var(--line)] shadow-xs overflow-hidden">
                <div className="flex items-center justify-between px-5 py-3.5 bg-gradient-to-r from-[var(--navy)] via-[#102A43] to-indigo-900">
                  <div className="flex items-center gap-2">
                    <Zap className="w-4.5 h-4.5 text-[var(--amber)]" />
                    <h3 className="text-sm font-black text-white uppercase tracking-wider">
                      Combine Test Snapshot Results
                    </h3>
                  </div>
                  <span className="px-2 py-0.5 rounded-full text-[10px] font-black bg-[var(--amber)]/20 text-[var(--amber)] border border-[var(--amber)]/30">
                    ⚡ Point-in-Time Test
                  </span>
                </div>
                        ...
                        >
                          ...
                          {hasHeat ? (
                            <div className="relative z-10 flex flex-col items-center bg-black/80 backdrop-blur-xs px-1.5 py-0.5 rounded-md border border-white/30 shadow-xs">
                              ...
                              <span className="text-[8px] font-black text-[var(--amber)] leading-none mt-0.5">
            ...
            return (
              <div className="bg-gradient-to-r from-slate-900 via-indigo-950 to-slate-900 text-white p-5 rounded-2xl border border-slate-800 shadow-md space-y-4">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-slate-800/80 pb-3">
                  <div className="flex items-center gap-3">
                    <div className="w-11 h-11 rounded-2xl bg-slate-800/80 border border-slate-700/80 flex items-center justify-center text-blue-400 shrink-0 overflow-hidden p-1 shadow-sm">
                      {activeLogo ? (
                        <img src={activeLogo} alt={teamName || 'Team Logo'} className="w-full h-full object-contain" />
                      ) : (
                    ...
                    <div>
                      <div className="flex items-center gap-2 flex-wrap">
                        <h2 className="text-lg font-black text-white tracking-tight flex items-center gap-2">
                          <span>{teamName || 'Active Team View'}</span>
                          {activeJumper && (
                            <img src={activeJumper} alt="Jumper" className="w-6 h-6 object-contain rounded border border-slate-700 shrink-0" title="Official Team Jumper" />
                          )}
                        </h2>
                        {isInactive ? (
                          <span className="px-2 py-0.5 text-[10px] font-black bg-amber-500/30 text-[var(--amber)] border border-amber-500/40 rounded-full uppercase tracking-wider">
                        ...
                        {onUpdateTeams && (
                          <button
                            ...
                            className="px-2.5 py-1 bg-blue-600/80 hover:bg-blue-500 text-white font-extrabold text-[11px] rounded-lg border border-blue-400/40 transition flex items-center gap-1 cursor-pointer"
                          >
                            <Edit3 className="w-3 h-3" />
                            <span>Edit Team & Branding</span>
                          </button>
                        )}
                      </div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
              ...
              <div className="bg-slate-900/80 border border-slate-800 p-3.5 rounded-xl space-y-1">
                ...
                <div className="flex flex-wrap gap-1 pt-1 text-[9px] font-extrabold">
                  ...
                  {awayCount > 0 && (
                    <span className="px-1.5 py-0.5 rounded bg-amber-500/20 text-[var(--amber)] border border-amber-500/30">
                      {awayCount} Away
                    </span>
                  )}
                </div>
                        ...
                        {POSITION_GROUPS[groupName].map((pos) => {
                          ...
                          return (
                            ...
                            >
                              ...
                              {POSITION_HEIGHT_FACTOR[norm] && (
                                <span className={`text-[8px] font-black uppercase mt-0.5 ${isSel ? 'text-blue-100' : 'text-slate-400'}`}>
                                  📏 {POSITION_HEIGHT_FACTOR[norm]}
                                </span>
                              )}
                            </button>
      ...
      {isEditTeamModalOpen && onUpdateTeams && (
        <TeamEditModal
          team={teams?.find((t) => t.id === activeTeamId) || null}
