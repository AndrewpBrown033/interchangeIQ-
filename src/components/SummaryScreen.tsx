...
import { ShieldCheck, UserX, Users, Trophy, History, Settings, CloudLightning, TrendingUp, RefreshCw, CheckCircle2, Landmark, Check, BookOpen, Bot, AlertTriangle } from 'lucide-react';
